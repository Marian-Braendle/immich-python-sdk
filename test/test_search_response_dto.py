    ...
    def make_instance(self, include_optional) -> SearchResponseDto:
        ...
        if include_optional:
            return SearchResponseDto(
                albums = immich_python_sdk_asyncio.models.search_album_response_dto.SearchAlbumResponseDto(
                    count = 56, 
                    facets = [
                        immich_python_sdk_asyncio.models.search_facet_response_dto.SearchFacetResponseDto(
                            counts = [
                                immich_python_sdk_asyncio.models.search_facet_count_response_dto.SearchFacetCountResponseDto(
                                    count = 56, 
                                    value = '', )
                                ], 
                            field_name = '', )
                    ...
                    items = [
                        immich_python_sdk_asyncio.models.album_response_dto.AlbumResponseDto(
                            album_name = '', 
                            album_thumbnail_asset_id = '', 
                            album_users = [
                                immich_python_sdk_asyncio.models.album_user_response_dto.AlbumUserResponseDto(
                                    role = null, 
                                    user = immich_python_sdk_asyncio.models.user_response_dto.UserResponseDto(
                                        avatar_color = null, 
                                        email = '', 
                                        id = '', 
                                        name = '', 
                            ...
                            asset_count = 56, 
                            assets = [
                                immich_python_sdk_asyncio.models.asset_response_dto.AssetResponseDto(
                                    checksum = '', 
                                    device_asset_id = '', 
                                    device_id = '', 
                                    duplicate_id = '', 
                                    duration = '', 
                                    exif_info = immich_python_sdk_asyncio.models.exif_response_dto.ExifResponseDto(
                                        city = '', 
                                        country = '', 
                                    ...
                                    original_mime_type = '', 
                                    original_path = '', 
                                    owner = immich_python_sdk_asyncio.models.user_response_dto.UserResponseDto(
                                        avatar_color = null, 
                                        email = '', 
                                        id = '', 
                                        name = '', 
                                    ...
                                    owner_id = '', 
                                    people = [
                                        immich_python_sdk_asyncio.models.person_with_faces_response_dto.PersonWithFacesResponseDto(
                                            birth_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                                            color = '', 
                                            faces = [
                                                immich_python_sdk_asyncio.models.asset_face_without_person_response_dto.AssetFaceWithoutPersonResponseDto(
                                                    bounding_box_x1 = 56, 
                                                    bounding_box_x2 = 56, 
                                                    bounding_box_y1 = 56, 
                                                    bounding_box_y2 = 56, 
                                    ...
                                    stack = null, 
                                    tags = [
                                        immich_python_sdk_asyncio.models.tag_response_dto.TagResponseDto(
                                            color = '', 
                    ...
                    total = 56, ),
                assets = immich_python_sdk_asyncio.models.search_asset_response_dto.SearchAssetResponseDto(
                    count = 56, 
                    facets = [
                        immich_python_sdk_asyncio.models.search_facet_response_dto.SearchFacetResponseDto(
                            counts = [
