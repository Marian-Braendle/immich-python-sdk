...
from immich_python_sdk_asyncio.api_client import ApiClient, RequestSerialized
from immich_python_sdk_asyncio.api_response import ApiResponse
from immich_python_sdk_asyncio.rest import RESTResponseType
...
class JobsApi:
    ...
    @validate_call
    async def get_all_jobs_status_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_all_jobs_status_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def send_job_command_with_http_info(
        self,
        id: JobName,
        job_command_dto: JobCommandDto,
        _request_timeout: Union[
    ...
    @validate_call
    async def send_job_command_without_preload_content(
        self,
        id: JobName,
        job_command_dto: JobCommandDto,
        _request_timeout: Union[
