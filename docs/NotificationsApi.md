# immich_python_sdk_asyncio.NotificationsApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.NotificationsApi(api_client)
    id = 'id_example' # str | 

    try:
        await api_instance.delete_notification(id)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.NotificationsApi(api_client)
    notification_delete_all_dto = immich_python_sdk_asyncio.NotificationDeleteAllDto() # NotificationDeleteAllDto | 

    try:
        await api_instance.delete_notifications(notification_delete_all_dto)
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_notification(id)
...
import immich_python_sdk_asyncio
from immich_python_sdk_asyncio.models.notification_dto import NotificationDto
from immich_python_sdk_asyncio.models.notification_level import NotificationLevel
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    level = immich_python_sdk_asyncio.NotificationLevel() # NotificationLevel |  (optional)
    type = immich_python_sdk_asyncio.NotificationType() # NotificationType |  (optional)
    unread = True # bool |  (optional)

    try:
        api_response = await api_instance.get_notifications(id=id, level=level, type=type, unread=unread)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.NotificationsApi(api_client)
    id = 'id_example' # str | 
    notification_update_dto = immich_python_sdk_asyncio.NotificationUpdateDto() # NotificationUpdateDto | 

    try:
        api_response = await api_instance.update_notification(id, notification_update_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.NotificationsApi(api_client)
    notification_update_all_dto = immich_python_sdk_asyncio.NotificationUpdateAllDto() # NotificationUpdateAllDto | 

    try:
        await api_instance.update_notifications(notification_update_all_dto)
    except Exception as e:
