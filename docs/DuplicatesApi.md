# immich_python_sdk_asyncio.DuplicatesApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.DuplicatesApi(api_client)

    try:
        api_response = await api_instance.get_asset_duplicates()
