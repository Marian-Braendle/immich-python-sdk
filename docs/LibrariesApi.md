# immich_python_sdk_asyncio.LibrariesApi
...
from immich_python_sdk_asyncio.models.library_response_dto import LibraryResponseDto
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.LibrariesApi(api_client)
    create_library_dto = immich_python_sdk_asyncio.CreateLibraryDto() # CreateLibraryDto | 

    try:
        api_response = await api_instance.create_library(create_library_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.delete_library(id)
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_all_libraries()
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_library(id)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_library_statistics(id)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.scan_library(id)
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.LibrariesApi(api_client)
    id = 'id_example' # str | 
    update_library_dto = immich_python_sdk_asyncio.UpdateLibraryDto() # UpdateLibraryDto | 

    try:
        api_response = await api_instance.update_library(id, update_library_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.LibrariesApi(api_client)
    id = 'id_example' # str | 
    validate_library_dto = immich_python_sdk_asyncio.ValidateLibraryDto() # ValidateLibraryDto | 

    try:
        api_response = await api_instance.validate(id, validate_library_dto)
