# immich_python_sdk_asyncio.MemoriesApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.MemoriesApi(api_client)
    id = 'id_example' # str | 
    bulk_ids_dto = immich_python_sdk_asyncio.BulkIdsDto() # BulkIdsDto | 

    try:
        api_response = await api_instance.add_memory_assets(id, bulk_ids_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.MemoriesApi(api_client)
    memory_create_dto = immich_python_sdk_asyncio.MemoryCreateDto() # MemoryCreateDto | 

    try:
        api_response = await api_instance.create_memory(memory_create_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.delete_memory(id)
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_memory(id)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.remove_memory_assets(id, bulk_ids_dto)
...
import immich_python_sdk_asyncio
from immich_python_sdk_asyncio.models.memory_response_dto import MemoryResponseDto
from immich_python_sdk_asyncio.models.memory_type import MemoryType
from immich_python_sdk_asyncio.rest import ApiException
from pprint import pprint
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    type = immich_python_sdk_asyncio.MemoryType() # MemoryType |  (optional)

    try:
        api_response = await api_instance.search_memories(var_for=var_for, is_saved=is_saved, is_trashed=is_trashed, type=type)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.MemoriesApi(api_client)
    id = 'id_example' # str | 
    memory_update_dto = immich_python_sdk_asyncio.MemoryUpdateDto() # MemoryUpdateDto | 

    try:
        api_response = await api_instance.update_memory(id, memory_update_dto)
