# immich_python_sdk.SharedLinksApi
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.SharedLinksApi(api_client)
    id = 'id_example' # str | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.SharedLinksApi(api_client)
    shared_link_create_dto = immich_python_sdk.SharedLinkCreateDto() # SharedLinkCreateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.SharedLinksApi(api_client)
    id = 'id_example' # str | 
    shared_link_edit_dto = immich_python_sdk.SharedLinkEditDto() # SharedLinkEditDto | 
