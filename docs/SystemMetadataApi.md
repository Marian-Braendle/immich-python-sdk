# immich_python_sdk.SystemMetadataApi
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.SystemMetadataApi(api_client)
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.SystemMetadataApi(api_client)
    admin_onboarding_update_dto = immich_python_sdk.AdminOnboardingUpdateDto() # AdminOnboardingUpdateDto | 
