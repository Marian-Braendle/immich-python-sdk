...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.TimelineApi(api_client)
    ...
    try:
        api_response = api_instance.get_time_bucket(time_bucket, album_id=album_id, is_favorite=is_favorite, is_trashed=is_trashed, key=key, order=order, page=page, page_size=page_size, person_id=person_id, tag_id=tag_id, user_id=user_id, visibility=visibility, with_partners=with_partners, with_stacked=with_stacked)
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_time_buckets(album_id=album_id, is_favorite=is_favorite, is_trashed=is_trashed, key=key, order=order, person_id=person_id, tag_id=tag_id, user_id=user_id, visibility=visibility, with_partners=with_partners, with_stacked=with_stacked)
