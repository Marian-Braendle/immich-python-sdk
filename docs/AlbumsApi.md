# immich_python_sdk_asyncio.AlbumsApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.AlbumsApi(api_client)
    id = 'id_example' # str | 
    bulk_ids_dto = immich_python_sdk_asyncio.BulkIdsDto() # BulkIdsDto | 
    key = 'key_example' # str |  (optional)

    try:
        api_response = await api_instance.add_assets_to_album(id, bulk_ids_dto, key=key)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.AlbumsApi(api_client)
    id = 'id_example' # str | 
    add_users_dto = immich_python_sdk_asyncio.AddUsersDto() # AddUsersDto | 

    try:
        api_response = await api_instance.add_users_to_album(id, add_users_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.AlbumsApi(api_client)
    create_album_dto = immich_python_sdk_asyncio.CreateAlbumDto() # CreateAlbumDto | 

    try:
        api_response = await api_instance.create_album(create_album_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.delete_album(id)
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_album_info(id, key=key, without_assets=without_assets)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_album_statistics()
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_all_albums(asset_id=asset_id, shared=shared)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.remove_asset_from_album(id, bulk_ids_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.remove_user_from_album(id, user_id)
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.AlbumsApi(api_client)
    id = 'id_example' # str | 
    update_album_dto = immich_python_sdk_asyncio.UpdateAlbumDto() # UpdateAlbumDto | 

    try:
        api_response = await api_instance.update_album_info(id, update_album_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    user_id = 'user_id_example' # str | 
    update_album_user_dto = immich_python_sdk_asyncio.UpdateAlbumUserDto() # UpdateAlbumUserDto | 

    try:
        await api_instance.update_album_user(id, user_id, update_album_user_dto)
    except Exception as e:
