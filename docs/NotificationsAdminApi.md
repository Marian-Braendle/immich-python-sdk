# immich_python_sdk.NotificationsAdminApi
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.NotificationsAdminApi(api_client)
    notification_create_dto = immich_python_sdk.NotificationCreateDto() # NotificationCreateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    template_dto = immich_python_sdk.TemplateDto() # TemplateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.NotificationsAdminApi(api_client)
    system_config_smtp_dto = immich_python_sdk.SystemConfigSmtpDto() # SystemConfigSmtpDto | 

    try:
        api_response = api_instance.send_test_email_admin(system_config_smtp_dto)
