# immich_python_sdk_asyncio.FacesApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.FacesApi(api_client)
    asset_face_create_dto = immich_python_sdk_asyncio.AssetFaceCreateDto() # AssetFaceCreateDto | 

    try:
        await api_instance.create_face(asset_face_create_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.FacesApi(api_client)
    id = 'id_example' # str | 
    asset_face_delete_dto = immich_python_sdk_asyncio.AssetFaceDeleteDto() # AssetFaceDeleteDto | 

    try:
        await api_instance.delete_face(id, asset_face_delete_dto)
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_faces(id)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.FacesApi(api_client)
    id = 'id_example' # str | 
    face_dto = immich_python_sdk_asyncio.FaceDto() # FaceDto | 

    try:
        api_response = await api_instance.reassign_faces_by_id(id, face_dto)
