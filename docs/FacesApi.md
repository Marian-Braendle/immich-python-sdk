...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.FacesApi(api_client)
    asset_face_create_dto = immich_python_sdk.AssetFaceCreateDto() # AssetFaceCreateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.FacesApi(api_client)
    id = 'id_example' # str | 
    asset_face_delete_dto = immich_python_sdk.AssetFaceDeleteDto() # AssetFaceDeleteDto | 
