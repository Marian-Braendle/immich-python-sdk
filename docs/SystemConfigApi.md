# immich_python_sdk.SystemConfigApi
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.SystemConfigApi(api_client)
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.SystemConfigApi(api_client)
    theme = immich_python_sdk.MapTheme() # MapTheme | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.SystemConfigApi(api_client)
    system_config_dto = immich_python_sdk.SystemConfigDto() # SystemConfigDto | 
