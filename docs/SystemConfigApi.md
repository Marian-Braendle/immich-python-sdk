# immich_python_sdk_asyncio.SystemConfigApi
...
from immich_python_sdk_asyncio.models.system_config_dto import SystemConfigDto
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.SystemConfigApi(api_client)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_config_defaults()
...
```python
import immich_python_sdk_asyncio
from immich_python_sdk_asyncio.models.system_config_template_storage_option_dto import SystemConfigTemplateStorageOptionDto
from immich_python_sdk_asyncio.rest import ApiException
from pprint import pprint
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_storage_template_options()
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.SystemConfigApi(api_client)
    system_config_dto = immich_python_sdk_asyncio.SystemConfigDto() # SystemConfigDto | 

    try:
        api_response = await api_instance.update_config(system_config_dto)
