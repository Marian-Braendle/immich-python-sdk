...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.StacksApi(api_client)
    stack_create_dto = immich_python_sdk.StackCreateDto() # StackCreateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.StacksApi(api_client)
    id = 'id_example' # str | 
    stack_update_dto = immich_python_sdk.StackUpdateDto() # StackUpdateDto | 
