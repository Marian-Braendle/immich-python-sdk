# immich_python_sdk_asyncio.SessionsApi

All URIs are relative to *https://github.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_session**](SessionsApi.md#create_session) | **POST** /sessions | 
...
[**lock_session**](SessionsApi.md#lock_session) | **POST** /sessions/{id}/lock | 
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.SessionsApi(api_client)
    session_create_dto = immich_python_sdk_asyncio.SessionCreateDto() # SessionCreateDto | 

    try:
        api_response = await api_instance.create_session(session_create_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.delete_all_sessions()
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.delete_session(id)
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_sessions()
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.lock_session(id)
    except Exception as e:
