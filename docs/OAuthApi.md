# immich_python_sdk_asyncio.OAuthApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.OAuthApi(api_client)
    o_auth_callback_dto = immich_python_sdk_asyncio.OAuthCallbackDto() # OAuthCallbackDto | 

    try:
        api_response = await api_instance.finish_o_auth(o_auth_callback_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.link_o_auth_account(o_auth_callback_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.redirect_o_auth_to_mobile()
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.OAuthApi(api_client)
    o_auth_config_dto = immich_python_sdk_asyncio.OAuthConfigDto() # OAuthConfigDto | 

    try:
        api_response = await api_instance.start_o_auth(o_auth_config_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.unlink_o_auth_account()
