...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.AuditApi(api_client)
    file_report_fix_dto = immich_python_sdk.FileReportFixDto() # FileReportFixDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.AuditApi(api_client)
    entity_type = immich_python_sdk.EntityType() # EntityType | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.AuditApi(api_client)
    file_checksum_dto = immich_python_sdk.FileChecksumDto() # FileChecksumDto | 
