...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.UserApi(api_client)
    file = None # bytearray | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.UserApi(api_client)
    create_user_dto = immich_python_sdk.CreateUserDto() # CreateUserDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.UserApi(api_client)
    update_user_dto = immich_python_sdk.UpdateUserDto() # UpdateUserDto | 
