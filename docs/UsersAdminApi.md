# immich_python_sdk.UsersAdminApi
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.UsersAdminApi(api_client)
    user_admin_create_dto = immich_python_sdk.UserAdminCreateDto() # UserAdminCreateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.UsersAdminApi(api_client)
    id = 'id_example' # str | 
    user_admin_delete_dto = immich_python_sdk.UserAdminDeleteDto() # UserAdminDeleteDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.UsersAdminApi(api_client)
    id = 'id_example' # str | 
    user_admin_update_dto = immich_python_sdk.UserAdminUpdateDto() # UserAdminUpdateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.UsersAdminApi(api_client)
    id = 'id_example' # str | 
    user_preferences_update_dto = immich_python_sdk.UserPreferencesUpdateDto() # UserPreferencesUpdateDto | 
