...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.JobsApi(api_client)
    job_create_dto = immich_python_sdk.JobCreateDto() # JobCreateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.JobsApi(api_client)
    id = immich_python_sdk.JobName() # JobName | 
    job_command_dto = immich_python_sdk.JobCommandDto() # JobCommandDto | 
