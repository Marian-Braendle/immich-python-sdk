# immich_python_sdk_asyncio.SearchApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.SearchApi(api_client)

    try:
        api_response = await api_instance.get_assets_by_city()
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_explore_data()
...
```python
import immich_python_sdk_asyncio
from immich_python_sdk_asyncio.models.search_suggestion_type import SearchSuggestionType
from immich_python_sdk_asyncio.rest import ApiException
from pprint import pprint
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.SearchApi(api_client)
    type = immich_python_sdk_asyncio.SearchSuggestionType() # SearchSuggestionType | 
    ...
    try:
        api_response = await api_instance.get_search_suggestions(type, country=country, include_null=include_null, make=make, model=model, state=state)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.SearchApi(api_client)
    metadata_search_dto = immich_python_sdk_asyncio.MetadataSearchDto() # MetadataSearchDto | 

    try:
        api_response = await api_instance.search_assets(metadata_search_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.search_person(name, with_hidden=with_hidden)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.search_places(name)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.SearchApi(api_client)
    random_search_dto = immich_python_sdk_asyncio.RandomSearchDto() # RandomSearchDto | 

    try:
        api_response = await api_instance.search_random(random_search_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.SearchApi(api_client)
    smart_search_dto = immich_python_sdk_asyncio.SmartSearchDto() # SmartSearchDto | 

    try:
        api_response = await api_instance.search_smart(smart_search_dto)
