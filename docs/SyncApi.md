# immich_python_sdk_asyncio.SyncApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.SyncApi(api_client)
    sync_ack_delete_dto = immich_python_sdk_asyncio.SyncAckDeleteDto() # SyncAckDeleteDto | 

    try:
        await api_instance.delete_sync_ack(sync_ack_delete_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.SyncApi(api_client)
    asset_delta_sync_dto = immich_python_sdk_asyncio.AssetDeltaSyncDto() # AssetDeltaSyncDto | 

    try:
        api_response = await api_instance.get_delta_sync(asset_delta_sync_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.SyncApi(api_client)
    asset_full_sync_dto = immich_python_sdk_asyncio.AssetFullSyncDto() # AssetFullSyncDto | 

    try:
        api_response = await api_instance.get_full_sync_for_user(asset_full_sync_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_sync_ack()
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.SyncApi(api_client)
    sync_stream_dto = immich_python_sdk_asyncio.SyncStreamDto() # SyncStreamDto | 

    try:
        await api_instance.get_sync_stream(sync_stream_dto)
    except Exception as e:
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.SyncApi(api_client)
    sync_ack_set_dto = immich_python_sdk_asyncio.SyncAckSetDto() # SyncAckSetDto | 

    try:
        await api_instance.send_sync_ack(sync_ack_set_dto)
    except Exception as e:
