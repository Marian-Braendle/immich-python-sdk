# immich_python_sdk_asyncio.PeopleApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.PeopleApi(api_client)
    person_create_dto = immich_python_sdk_asyncio.PersonCreateDto() # PersonCreateDto | 

    try:
        api_response = await api_instance.create_person(person_create_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_all_people(closest_asset_id=closest_asset_id, closest_person_id=closest_person_id, page=page, size=size, with_hidden=with_hidden)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_person(id)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_person_statistics(id)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_person_thumbnail(id)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.PeopleApi(api_client)
    id = 'id_example' # str | 
    merge_person_dto = immich_python_sdk_asyncio.MergePersonDto() # MergePersonDto | 

    try:
        api_response = await api_instance.merge_person(id, merge_person_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.PeopleApi(api_client)
    id = 'id_example' # str | 
    asset_face_update_dto = immich_python_sdk_asyncio.AssetFaceUpdateDto() # AssetFaceUpdateDto | 

    try:
        api_response = await api_instance.reassign_faces(id, asset_face_update_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk_asyncio.PeopleApi(api_client)
    people_update_dto = immich_python_sdk_asyncio.PeopleUpdateDto() # PeopleUpdateDto | 

    try:
        api_response = await api_instance.update_people(people_update_dto)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.PeopleApi(api_client)
    id = 'id_example' # str | 
    person_update_dto = immich_python_sdk_asyncio.PersonUpdateDto() # PersonUpdateDto | 

    try:
        api_response = await api_instance.update_person(id, person_update_dto)
