...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.TagsApi(api_client)
    tag_bulk_assets_dto = immich_python_sdk.TagBulkAssetsDto() # TagBulkAssetsDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.TagsApi(api_client)
    tag_create_dto = immich_python_sdk.TagCreateDto() # TagCreateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk.TagsApi(api_client)
    id = 'id_example' # str | 
    tag_update_dto = immich_python_sdk.TagUpdateDto() # TagUpdateDto | 
...
with immich_python_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = immich_python_sdk.TagsApi(api_client)
    tag_upsert_dto = immich_python_sdk.TagUpsertDto() # TagUpsertDto | 
