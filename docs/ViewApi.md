# immich_python_sdk_asyncio.ViewApi
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = immich_python_sdk_asyncio.ViewApi(api_client)
    path = 'path_example' # str | 

    try:
        api_response = await api_instance.get_assets_by_original_path(path)
...
async with immich_python_sdk_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_unique_original_paths()
